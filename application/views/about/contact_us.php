...
<div class="row m-0 p-0">
    ...
    <div class="col-12 contact  ">
        <div class="shadow-lg card m-sm-5 p-sm-3 m-1 p-3 rounded">
            <div class="row p-0">
                <div class="col-12">
                    <h1 class="p-0 m-0 fw-bold text-primary text-center">CONTACT US
                    </h1>
                </div>
                ...
                <div class="col-12 col-sm-4">
                    ...
                    <div class="pt-2">
                        ...
                        <p class="my-3">
                        <i class="fas fa-envelope me-3"></i> AUN-HPN_th@mahidol.ac.th
                        </p>
